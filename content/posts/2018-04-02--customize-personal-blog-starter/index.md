...
To read the whole instruction article - [How to customize the personalBlog starter's appearance](https://dev.restry.cn/customize-personal-blog-starter/) - you have to move to [Front-end web development with Restry](https://dev.restry.cn) website.
