...
To read the whole instruction article - [Setup Algolia account for your GatsbyJS blog](https://dev.restry.cn/setup-algolia-account/) - you have to move to [Front-end web development with Restry](https://dev.restry.cn) website.
