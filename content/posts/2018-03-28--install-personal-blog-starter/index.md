...
To read the whole instruction article - [How to install, setup and add new content to the personalBlog starter](https://dev.restry.cn/install-personal-blog-starter/) - you have to move to [Front-end web development with Restry](https://dev.restry.cn) website.
